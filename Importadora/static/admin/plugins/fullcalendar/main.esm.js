...
function computeTitle(dateProfile, viewOptions) {
    var range;
    // for function that span a large unit of time, show the proper interval, ignoring stray days before and after
...
var Calendar = /** @class */ (function () {
    ...
    */
    ...
    // Preference is given to function that have corresponding buttons.
    Calendar.prototype.getUnitViewSpec = function (unit) {
        var component = this.component;
        var viewTypes = [];
        var i;
        var spec;
        // put function that have buttons first. there will be duplicates, but oh
        if (component.header) {
